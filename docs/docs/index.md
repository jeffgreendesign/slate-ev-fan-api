...
Welcome to the documentation for this unofficial Slate EV Truck fan API. This API provides public information about the Slate Truck, including preproduction specifications, features, source notes, and known unknowns.
